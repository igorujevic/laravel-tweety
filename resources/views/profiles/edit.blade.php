<x-app>
  <form action="{{ $user->path() }}" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-6">
      <div>
        <label for="avatar" class="block mb-2 font-bold text-xs text-gray-700">
          Avatar
        </label>
        <input
          class="border border-gray-400 p-2 w-full"
      ...
      <img class="mt-4" src=" {{ $user->avatar }} " alt="avatar" width="50">
    ...
    <div class="mb-6">
      <label for="password_confirmation" class="block mb-2 font-bold text-xs text-gray-700">
